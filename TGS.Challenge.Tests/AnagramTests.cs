...
namespace TGS.Challenge.Tests
{
  public class AnagramTests
  {
    ...
    {
        // I updated the word2 because (maybe I didn't understand well what anagram is), but Reel  fun is not an anagram of Funeral, 
        // because it does not contain exactly the same letters, Reel has double ee
      var result = _anagram.AreAnagrams("Funeral", "Rael fun");
